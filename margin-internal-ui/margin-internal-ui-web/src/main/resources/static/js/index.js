$(function () {
    ...
    $(".btnRun").click(function () {
        ...
        $.ajax({
            ...
            url: "/internal/ui/v1/schedule/run",
            dataType: "json",
            data: JSON.stringify({
    ...
    $(".btnPause").click(function () {
        ...
        $.ajax({
            type: 'POST',
            contentType: 'application/json',
            url: "/internal/ui/v1/schedule/pause",
            dataType: "json",
            data: JSON.stringify({
                "channel": $("#channel_" + jobId).text(),
                "country": $("#country_" + jobId).text()
    ...
    $(".btnResume").click(function () {
        ...
        $.ajax({
            type: 'POST',
            contentType: 'application/json',
            url: "/internal/ui/v1/schedule/resume",
            dataType: "json",
            data: JSON.stringify({
                "channel": $("#channel_" + jobId).text(),
                "country": $("#country_" + jobId).text()
    ...
    $(".btnDelete").click(function () {
        ...
        $.ajax({
            type: 'POST',
            contentType: 'application/json',
            url: "/internal/ui/v1/schedule/delete",
            dataType: "json",
            data: JSON.stringify({
                "channel": $("#channel_" + jobId).text(),
                "country": $("#country_" + jobId).text()
    ...
    $(".btnEdit").click(
        function () {
            ...
            $("#sourceInfoId").val($("#source_" + jobId).text());
    ...
    $("#save").click(
        function () {
            ...
            let json = getFormData($('#mainForm'));
            console.log(json);
            console.log(JSON.stringify(json));
            $.ajax({
                type: 'POST',
                contentType: 'application/json',
                url: "/internal/ui/v1/schedule/save",
